--- Configuration table.
CONSTANTS = {
  blueZones = {}, -- Blue player zones configuration table.
  redZones = {}, -- Blue player zones configuration table.
...
--- Blue player zones configuration table.
CONSTANTS.blueZones = {
...
--- Red player zones configuration table.
CONSTANTS.redZones = {
